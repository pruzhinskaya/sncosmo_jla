...
from scipy.interpolate import InterpolatedUnivariateSpline as Spline1d # masha
from extinction import ccm89 #masha
...
class Bandpass(object):
    ...
    # masha_beg
    def wave_eff_snfit(self,EBV=0,z=0,Rv=3.1):
        rest_wave = self.wave*(1+np.array(z))
        spl = Spline1d(rest_wave, self.trans, k=1, ext = 1)
        dt = 10000
