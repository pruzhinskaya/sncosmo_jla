...
from read_jla import new_Table
import numpy as np
import copy
...
def fit_salt2():
    ...
    list_SDSS = ['lc-SDSS17240.list','lc-SDSS12977.list']
...
def chi2(name=None):
    ...
    model = sncosmo.Model(source=source,effects=[dust],effect_names=['mw'],effect_frames=['obs'])
    model.set(mwebv=head['@MWEBV'], z=head['@Z_HELIO'], t0=54337.325699, x0=0.000968961137087,x1=-1.466919,c=-0.121433) #
